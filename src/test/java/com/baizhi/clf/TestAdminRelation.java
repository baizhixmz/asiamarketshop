...
public class TestAdminRelation extends BaseTest {
	...
	public void testAdminCategory() {
		List<SadminCategoryEntity> sadminCategoryEntities = adminRelationDAO
				.selectAdminCategorys("8a8ab0b246dc81120146dc8181950052");
	...
	public void testAdminProduct() {
		List<SadminProductEntity> sadminProductEntities = adminRelationDAO
				.selectAdminProducts("8a8ab0b246dc81120146dc8181950052");
